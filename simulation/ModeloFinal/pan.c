...
short src_ln8 [] = {
	  0, 324, 328, 329, 330, 331, 332, 327, 
	336, 327, 337, 339, 340, 341, 342, 343, 
	344, 339, 348, 339, 348, 349, 350, 351, 
	352, 355, 356,   0, };
S_F_MAP src_file8 [] = {
	{ "-", 0, 0 },
	{ "trabajo.pml", 1, 26 },
...
short src_ln7 [] = {
	  0, 263, 265, 266, 267, 268, 264, 270, 
	262, 273, 262, 274, 276, 277, 278, 279, 
	275, 281, 273, 284, 273, 285, 287, 288, 
	289, 290, 286, 292, 284, 295, 284, 296, 
	298, 299, 300, 301, 297, 303, 295, 306, 
	295, 307, 309, 310, 311, 312, 308, 314, 
	306, 315, 306, 315,   0, };
S_F_MAP src_file7 [] = {
	{ "-", 0, 0 },
	{ "trabajo.pml", 1, 51 },
...
short src_ln6 [] = {
	  0, 235, 238, 239, 240, 241, 237, 243, 
	243, 244, 245, 234, 247, 234, 247, 248, 
	  0, };
S_F_MAP src_file6 [] = {
	{ "-", 0, 0 },
	{ "trabajo.pml", 1, 15 },
...
short src_ln5 [] = {
	  0, 216, 219, 220, 221, 222, 218, 224, 
	224, 225, 226, 215, 228, 215, 228, 229, 
	  0, };
S_F_MAP src_file5 [] = {
	{ "-", 0, 0 },
	{ "trabajo.pml", 1, 15 },
...
short src_ln4 [] = {
	  0, 197, 200, 201, 202, 203, 199, 205, 
	205, 206, 207, 196, 209, 196, 209, 210, 
	  0, };
S_F_MAP src_file4 [] = {
	{ "-", 0, 0 },
	{ "trabajo.pml", 1, 15 },
...
short src_ln3 [] = {
	  0, 177, 180, 181, 182, 183, 179, 185, 
	185, 186, 187, 176, 189, 176, 189, 190, 
	  0, };
S_F_MAP src_file3 [] = {
	{ "-", 0, 0 },
	{ "trabajo.pml", 1, 15 },
...
short src_ln2 [] = {
	  0, 155, 158, 159, 160, 161, 157, 163, 
	163, 165, 166, 154, 170, 154, 170, 171, 
	  0, };
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "trabajo.pml", 1, 15 },
...
short src_ln1 [] = {
	  0, 108, 112, 114, 116, 119, 120, 123, 
	124, 125, 126, 129, 130, 133, 117, 111, 
	136, 107, 138, 107, 138, 139,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "trabajo.pml", 1, 21 },
	{ "-", 22, 23 }
...
short src_ln0 [] = {
	  0,  56,  68,  74,  76,  77,  55,  81, 
	 55,  81,  84,  90,  91,  92,  93,  83, 
	 95,  83,  95,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "trabajo.pml", 1, 18 },
...
{	int j = 0, h = now._nr_pr;
	...
	case 8:	/* :init: */
		...
		((P8 *)pptr(h))->k = 0;
#ifdef VAR_RANGES
		logval(":init::i", ((P8 *)pptr(h))->i);
		logval(":init::j", ((P8 *)pptr(h))->j);
		logval(":init::k", ((P8 *)pptr(h))->k);
#endif
#ifdef HAS_CODE
		locinit8(h);
#endif
	...
	case 7:	/* Aggregator */
		...
		((P7 *)pptr(h))->value = 0;
#ifdef VAR_RANGES
		logval("Aggregator:value", ((P7 *)pptr(h))->value);
#endif
#ifdef HAS_CODE
		locinit7(h);
#endif
	...
	case 6:	/* DetectTexts */
		...
		((P6 *)pptr(h))->i = 0;
#ifdef VAR_RANGES
		logval("DetectTexts:i", ((P6 *)pptr(h))->i);
#endif
#ifdef HAS_CODE
		locinit6(h);
#endif
	...
	case 5:	/* DetectTypes */
		...
		((P5 *)pptr(h))->i = 0;
#ifdef VAR_RANGES
		logval("DetectTypes:i", ((P5 *)pptr(h))->i);
#endif
#ifdef HAS_CODE
		locinit5(h);
#endif
	...
	case 4:	/* DetectPairs */
		...
		((P4 *)pptr(h))->i = 0;
#ifdef VAR_RANGES
		logval("DetectPairs:i", ((P4 *)pptr(h))->i);
#endif
#ifdef HAS_CODE
		locinit4(h);
#endif
		break;
	case 3:	/* DetectTargets */
		((P3 *)pptr(h))->_t = 3;
		((P3 *)pptr(h))->_p = 11;
#ifdef HAS_PRIORITY
		...
		((P3 *)pptr(h))->i = 0;
#ifdef VAR_RANGES
		logval("DetectTargets:i", ((P3 *)pptr(h))->i);
#endif
#ifdef HAS_CODE
		locinit3(h);
#endif
	...
	case 2:	/* DetectUsers */
		...
		((P2 *)pptr(h))->i = 0;
#ifdef VAR_RANGES
		logval("DetectUsers:i", ((P2 *)pptr(h))->i);
#endif
#ifdef HAS_CODE
		locinit2(h);
#endif
	...
	case 1:	/* Worker */
		...
		/* locals: */
		((P1 *)pptr(h))->userKey = 0;
		((P1 *)pptr(h))->targetKey = 0;
		((P1 *)pptr(h))->typeKey = 0;
		((P1 *)pptr(h))->textKey = 0;
		((P1 *)pptr(h))->pairIndex = 0;
#ifdef VAR_RANGES
		logval("Worker:id", ((P1 *)pptr(h))->id);
		logval("Worker:userKey", ((P1 *)pptr(h))->userKey);
		logval("Worker:targetKey", ((P1 *)pptr(h))->targetKey);
		logval("Worker:typeKey", ((P1 *)pptr(h))->typeKey);
		logval("Worker:textKey", ((P1 *)pptr(h))->textKey);
		logval("Worker:pairIndex", ((P1 *)pptr(h))->pairIndex);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		...
		{
			now.UserConts[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			now.TargetConts[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			now.PairConts[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			now.TypeConts[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			now.TextConts[l_in] = 0;
		}
	}
		now.records = addqueue(calling_pid, 1, 0);
		now.done = addqueue(calling_pid, 2, 0);
		now.usersCh = addqueue(calling_pid, 3, 0);
		now.targetsCh = addqueue(calling_pid, 4, 0);
		now.pairsCh = addqueue(calling_pid, 5, 0);
		now.typesCh = addqueue(calling_pid, 6, 0);
		now.textsCh = addqueue(calling_pid, 7, 0);
#ifdef VAR_RANGES
		logval("mutex", now.mutex);
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			logval("UserConts[l_in]", now.UserConts[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			logval("TargetConts[l_in]", now.TargetConts[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			logval("PairConts[l_in]", now.PairConts[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			logval("TypeConts[l_in]", now.TypeConts[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			logval("TextConts[l_in]", now.TextConts[l_in]);
		}
	}
#endif
}
...
#endif
	switch (n) {
	case 7: j = sizeof(Q7); q_flds[7] = 1; q_max[7] = 10; break;
	case 6: j = sizeof(Q6); q_flds[6] = 1; q_max[6] = 10; break;
	case 5: j = sizeof(Q5); q_flds[5] = 1; q_max[5] = 10; break;
	case 4: j = sizeof(Q4); q_flds[4] = 1; q_max[4] = 10; break;
	case 3: j = sizeof(Q3); q_flds[3] = 1; q_max[3] = 10; break;
	case 2: j = sizeof(Q2); q_flds[2] = 1; q_max[2] = 2; break;
	case 1: j = sizeof(Q1); q_flds[1] = 4; q_max[1] = 10; break;
...
{	int i = 0;
	...
	{	if (t->ty[i] == TIMEOUT_F) return 1;
		...
		switch (t->qu[i]) {
		case 0: break;
		case 1: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.records) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.records) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.records) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.records) )))
			    ) return 0; break;
		case 2: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.done) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.done) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.done) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.done) )))
			    ) return 0; break;
		case 3: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.usersCh) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.usersCh) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.usersCh) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.usersCh) )))
			    ) return 0; break;
		case 4: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.targetsCh) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.targetsCh) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.targetsCh) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.targetsCh) )))
			    ) return 0; break;
		case 5: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.pairsCh) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.pairsCh) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.pairsCh) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.pairsCh) )))
			    ) return 0; break;
		case 6: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.typesCh) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.typesCh) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.typesCh) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.typesCh) )))
			    ) return 0; break;
		case 7: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.textsCh) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.textsCh) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.textsCh) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.textsCh) )))
			    ) return 0; break;
...
{	/* int i; */
	printf("global vars:\n");
	printf("	chan records (=%d):	len %d:\t", now.records, q_len(now.records));
	c_chandump(now.records);
	printf("	chan done (=%d):	len %d:\t", now.done, q_len(now.done));
	c_chandump(now.done);
	printf("	chan usersCh (=%d):	len %d:\t", now.usersCh, q_len(now.usersCh));
	c_chandump(now.usersCh);
	printf("	chan targetsCh (=%d):	len %d:\t", now.targetsCh, q_len(now.targetsCh));
	c_chandump(now.targetsCh);
	printf("	chan pairsCh (=%d):	len %d:\t", now.pairsCh, q_len(now.pairsCh));
	c_chandump(now.pairsCh);
	printf("	chan typesCh (=%d):	len %d:\t", now.typesCh, q_len(now.typesCh));
	c_chandump(now.typesCh);
	printf("	chan textsCh (=%d):	len %d:\t", now.textsCh, q_len(now.textsCh));
	c_chandump(now.textsCh);
	printf("	bit    mutex:	%d\n", now.mutex);
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			printf("	byte   UserConts[%d]:	%d\n", l_in, now.UserConts[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			printf("	byte   TargetConts[%d]:	%d\n", l_in, now.TargetConts[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			printf("	byte   PairConts[%d]:	%d\n", l_in, now.PairConts[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			printf("	byte   TypeConts[%d]:	%d\n", l_in, now.TypeConts[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 10; l_in++)
		{
			printf("	byte   TextConts[%d]:	%d\n", l_in, now.TextConts[l_in]);
		}
	}
}
void
...
{	/* int i; */
	...
	printf("	byte   k:	%d\n", ((P8 *)pptr(pid))->k);
		break;
	case 7:
		printf("local vars proc %d (Aggregator):\n", pid);
	printf("	byte   value:	%d\n", ((P7 *)pptr(pid))->value);
		break;
	case 6:
		printf("local vars proc %d (DetectTexts):\n", pid);
	printf("	byte   i:	%d\n", ((P6 *)pptr(pid))->i);
		break;
	case 5:
		printf("local vars proc %d (DetectTypes):\n", pid);
	printf("	byte   i:	%d\n", ((P5 *)pptr(pid))->i);
		break;
	case 4:
		printf("local vars proc %d (DetectPairs):\n", pid);
	printf("	byte   i:	%d\n", ((P4 *)pptr(pid))->i);
		break;
	case 3:
		printf("local vars proc %d (DetectTargets):\n", pid);
	printf("	byte   i:	%d\n", ((P3 *)pptr(pid))->i);
		break;
	case 2:
		printf("local vars proc %d (DetectUsers):\n", pid);
	printf("	byte   i:	%d\n", ((P2 *)pptr(pid))->i);
		break;
	case 1:
		printf("local vars proc %d (Worker):\n", pid);
	printf("	byte   id:	%d\n", ((P1 *)pptr(pid))->id);
	printf("	byte   userKey:	%d\n", ((P1 *)pptr(pid))->userKey);
	printf("	byte   targetKey:	%d\n", ((P1 *)pptr(pid))->targetKey);
	printf("	byte   typeKey:	%d\n", ((P1 *)pptr(pid))->typeKey);
	printf("	byte   textKey:	%d\n", ((P1 *)pptr(pid))->textKey);
	printf("	byte   pairIndex:	%d\n", ((P1 *)pptr(pid))->pairIndex);
		break;
	case 0:
