...
#define _nstates8	27	/* :init: */
#define minseq8	165
#define maxseq8	190
#define _endstate8	26

#define _nstates7	52	/* Aggregator */
#define minseq7	114
#define maxseq7	164
#define _endstate7	51

#define _nstates6	16	/* DetectTexts */
#define minseq6	99
#define maxseq6	113
#define _endstate6	15

#define _nstates5	16	/* DetectTypes */
#define minseq5	84
#define maxseq5	98
#define _endstate5	15

#define _nstates4	16	/* DetectPairs */
#define minseq4	69
#define maxseq4	83
#define _endstate4	15

#define _nstates3	16	/* DetectTargets */
#define minseq3	54
#define maxseq3	68
#define _endstate3	15

#define _nstates2	16	/* DetectUsers */
#define minseq2	39
#define maxseq2	53
#define _endstate2	15

#define _nstates1	22	/* Worker */
#define minseq1	18
#define maxseq1	38
#define _endstate1	21

#define _nstates0	19	/* Reader */
#define minseq0	0
#define maxseq0	17
...
#define Pinit	((P8 *)_this)
typedef struct P8 { /* :init: */
...
#define Air8	(sizeof(P8) - Offsetof(P8, k) - 1*sizeof(uchar))

#define PAggregator	((P7 *)_this)
typedef struct P7 { /* Aggregator */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air7	(sizeof(P7) - Offsetof(P7, value) - 1*sizeof(uchar))

#define PDetectTexts	((P6 *)_this)
typedef struct P6 { /* DetectTexts */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air6	(sizeof(P6) - Offsetof(P6, i) - 1*sizeof(uchar))

#define PDetectTypes	((P5 *)_this)
typedef struct P5 { /* DetectTypes */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air5	(sizeof(P5) - Offsetof(P5, i) - 1*sizeof(uchar))

#define PDetectPairs	((P4 *)_this)
typedef struct P4 { /* DetectPairs */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air4	(sizeof(P4) - Offsetof(P4, i) - 1*sizeof(uchar))

#define PDetectTargets	((P3 *)_this)
typedef struct P3 { /* DetectTargets */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air3	(sizeof(P3) - Offsetof(P3, i) - 1*sizeof(uchar))

#define PDetectUsers	((P2 *)_this)
typedef struct P2 { /* DetectUsers */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define PWorker	((P1 *)_this)
typedef struct P1 { /* Worker */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, pairIndex) - 1*sizeof(uchar))
