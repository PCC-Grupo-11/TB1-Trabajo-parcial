...
#define _nstates7	26	/* :init: */
#define minseq7	74
#define maxseq7	98
#define _endstate7	25

#define _nstates6	6	/* Aggregator */
#define minseq6	69
#define maxseq6	73
#define _endstate6	5

#define _nstates5	9	/* DetectTypes */
#define minseq5	61
#define maxseq5	68
#define _endstate5	8

#define _nstates4	9	/* DetectPairs */
#define minseq4	53
#define maxseq4	60
#define _endstate4	8

#define _nstates3	9	/* DetectTargets */
#define minseq3	45
#define maxseq3	52
#define _endstate3	8

#define _nstates2	9	/* DetectUsers */
#define minseq2	37
#define maxseq2	44
#define _endstate2	8

#define _nstates1	20	/* Worker */
#define minseq1	18
#define maxseq1	36
...
#define Air7	(sizeof(P7) - Offsetof(P7, k) - 1*sizeof(uchar))

#define PAggregator	((P6 *)_this)
typedef struct P6 { /* Aggregator */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air6	(sizeof(P6) - Offsetof(P6, ty) - 1*sizeof(int))
...
#define Air5	(sizeof(P5) - Offsetof(P5, anomalous) - 1*sizeof(int))
...
#define Air4	(sizeof(P4) - Offsetof(P4, anomalous) - 1*sizeof(int))
...
#define Air3	(sizeof(P3) - Offsetof(P3, anomalous) - 1*sizeof(int))
...
#define Air2	(sizeof(P2) - Offsetof(P2, anomalous) - 1*sizeof(int))
...
#define Air1	(sizeof(P1) - Offsetof(P1, typeKey) - 1*sizeof(int))
